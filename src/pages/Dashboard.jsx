...
const Dashboard = () => {
  ...
  const upcomingProcedures = [
    { id: 1, patient: 'John Doe', procedure: 'Knee Replacement', time: '09:00 AM', status: 'Scheduled' },
    { id: 2, patient: 'Jane Smith', procedure: 'Cataract Surgery', time: '10:30 AM', status: 'Pre-op' },
    { id: 3, patient: 'Mike Johnson', procedure: 'Appendectomy', time: '01:15 PM', status: 'Scheduled' },
    { id: 4, patient: 'Sarah Wilson', procedure: 'Hip Replacement', time: '03:00 PM', status: 'Pre-op' }
  ];

  const quickStats = [
    { title: 'OR Utilization', value: '78%', trend: '+5%', positive: true },
    { title: 'Patient Satisfaction', value: '94%', trend: '+2%', positive: true },
    { title: 'Avg. Wait Time', value: '32min', trend: '-8min', positive: true },
    { title: 'Staff Availability', value: '92%', trend: '-3%', positive: false }
  ];
            ...
            {upcomingProcedures.map((procedure) => (
              <div key={procedure.id} className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-600">{procedure.procedure}</div>
                </div>
